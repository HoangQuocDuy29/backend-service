...
public class UserController {
    ...
    @GetMapping("/{userId}")
    public Map<String, Object> getUserDetail(@PathVariable @Min(value = 1, message = "ID phải có giá trị > 0") Long userId) {
    ...
    public void confirmEmail(@RequestParam String secretCode, HttpServletResponse response) throws IOException, IOException {
        ...
        try {
            ...
            response.sendRedirect("https://facebook.com/me");
        }
    }
    ...
    public Map<String, Object> deleteUser(@PathVariable @Min(value = 1, message = "ID phải có giá trị > 0") Long userId) {
